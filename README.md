...
This is the repository for the ec project at [Kings Digital Lab](https://kdl.kcl.ac.uk)
...
1. Enter the project directory: `cd ec-django`
...
1. Data curator
2. Open refine
3. Add columns to link to wikidata
