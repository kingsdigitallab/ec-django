...
def collect_data(data_dir, locations_csv):
    ...
    births_df.to_csv('data/extracted/births.tsv', sep='\t', index=False)
    deaths_df.to_csv('data/extracted/deaths.tsv', sep='\t', index=False)
    marriages_df.to_csv('data/extracted/marriages.tsv', sep='\t', index=False)
...
if __name__ == '__main__':
    collect_data('data', 'data/locations.csv')
